...
impl LiveTranscriptOverlay {
    ...
    #[allow(dead_code)] // exposed for callers that retain an overlay across a backtrack cancel; current UI just pops the view. (see #3490)
    ...
    #[allow(dead_code)]
    // currently consumed only by tests; kept public for symmetry (see #3490)
    #[must_use]
