...
pub enum MessageId {
    ...
    CmdTutorialDescription,
    TutorialComingFromTitle,
    TutorialComingFromBody,
    TutorialKeysTitle,
    TutorialKeysBody,
    TutorialComposerTitle,
    TutorialComposerBody,
    TutorialModelTitle,
    TutorialModelBody,
    TutorialFleetTitle,
    TutorialFleetBody,
    TutorialWorkflowsTitle,
    TutorialWorkflowsBody,
    CmdClearDescription,
    ...
    KbYank,
    KbCopyFocusedBlock,
    KbCopyFocusedBlockMetadata,
    KbFocusedBlockRaw,
    ToastCopiedBlock,
    ToastCopiedBlockMetadata,
    ToastBlockEmpty,
    ToastCopyFailed,
    KbToggleFileTree,
    KbSelectText,
    ...
    PhaseReading,
    PhaseUsingTool,
    /// Screen-steering work (screenshots, clicks, typed desktop input).
    PhaseComputerUse,
    ...
    PhaseVerifying,
    /// Idle `/loop` watchers still listening.
    PhaseWatching,
    PhaseWaitingOnYou,
    PhaseDone,
    PhaseFailed,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::CmdTutorialDescription,
    MessageId::TutorialComingFromTitle,
    MessageId::TutorialComingFromBody,
    MessageId::TutorialKeysTitle,
    MessageId::TutorialKeysBody,
    MessageId::TutorialComposerTitle,
    MessageId::TutorialComposerBody,
    MessageId::TutorialModelTitle,
    MessageId::TutorialModelBody,
    MessageId::TutorialFleetTitle,
    MessageId::TutorialFleetBody,
    ...
    MessageId::CmdRelaunchDescription,
    ...
    MessageId::CmdLoopDescription,
    MessageId::LoopUsage,
    MessageId::LoopCreated,
    MessageId::AutomationWatchersHeading,
    ...
    MessageId::KbYank,
    MessageId::KbCopyFocusedBlock,
    MessageId::KbCopyFocusedBlockMetadata,
    MessageId::KbFocusedBlockRaw,
    MessageId::ToastCopiedBlock,
    MessageId::ToastCopiedBlockMetadata,
    MessageId::ToastBlockEmpty,
    MessageId::ToastCopyFailed,
    ...
    MessageId::PhaseComputerUse,
    MessageId::PhaseSubagents,
    MessageId::PhaseVerifying,
    MessageId::PhaseWatching,
