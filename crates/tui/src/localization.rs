...
pub enum MessageId {
    ...
    // Onboarding screens — tools / MCP / skills / plugins step (#3407).
    OnboardToolsMcpTitle,
    OnboardToolsMcpLine1,
    OnboardToolsMcpLine2,
    OnboardToolsMcpLine3,
    OnboardToolsMcpLine4,
    OnboardToolsMcpMcpLabel,
    OnboardToolsMcpSkillsLabel,
    OnboardToolsMcpPluginsLabel,
    OnboardToolsMcpFooterEnter,
    OnboardToolsMcpFooterAction,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::OnboardToolsMcpTitle,
    MessageId::OnboardToolsMcpLine1,
    MessageId::OnboardToolsMcpLine2,
    MessageId::OnboardToolsMcpLine3,
    MessageId::OnboardToolsMcpLine4,
    MessageId::OnboardToolsMcpMcpLabel,
    MessageId::OnboardToolsMcpSkillsLabel,
    MessageId::OnboardToolsMcpPluginsLabel,
    MessageId::OnboardToolsMcpFooterEnter,
    MessageId::OnboardToolsMcpFooterAction,
