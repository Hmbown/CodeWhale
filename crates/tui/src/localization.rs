...
pub enum MessageId {
    ...
    PluginReceiptInstalled,
    PluginReceiptInstalledDetailed,
    PluginReceiptUpdated,
    PluginReceiptUpdatedDetailed,
    PluginReceiptAlreadyUpToDate,
    PluginReceiptUninstalled,
    PluginReceiptNeedsNetworkApproval,
    PluginReceiptNetworkDenied,
    PluginReceiptTrusted,
    PluginReceiptEnabled,
    PluginReceiptDisabled,
    PluginReceiptTrustRevoked,
    PluginReceiptValidation,
    PluginReceiptValidationAll,
    PluginReceiptValidationValid,
    PluginReceiptValidationInvalid,
    PluginReceiptReloaded,
    PluginReceiptReviewRequired,
    PluginReceiptWorkspaceReloaded,
    ExtensionsManagerTitle,
    ExtensionsManagerTabs,
    ExtensionsManagerInstalled,
    ExtensionsManagerMarketplace,
    ExtensionsManagerMarketplaceUnavailable,
    ExtensionsManagerMarketplaceBody,
    ExtensionsManagerDetails,
    ExtensionsManagerNoPlugins,
    ExtensionsManagerNoPluginsBody,
    ExtensionsManagerNoSelection,
    ExtensionsManagerNoSelectionBody,
    ExtensionsManagerVersion,
    ExtensionsManagerSource,
    ExtensionsManagerScope,
    ExtensionsManagerState,
    ExtensionsManagerTrustStatus,
    ExtensionsManagerComponents,
    ExtensionsManagerPermissions,
    ExtensionsManagerMcpServers,
    ExtensionsManagerInactiveCapabilities,
    ExtensionsManagerReviewToken,
    ExtensionsManagerDescription,
    ExtensionsManagerDiagnostics,
    ExtensionsManagerSearch,
    ExtensionsManagerSearchIdle,
    ExtensionsManagerMove,
    ExtensionsManagerToggle,
    ExtensionsManagerTrust,
    ExtensionsManagerReload,
    ExtensionsManagerTab,
    ExtensionsManagerClose,
    ExtensionsManagerConfirm,
    ExtensionsManagerCancel,
    ExtensionsManagerCancelled,
    ExtensionsManagerConfirmDisable,
    ExtensionsManagerConfirmRevoke,
    ExtensionsManagerConfirmUpdate,
    ExtensionsManagerConfirmUninstall,
    ExtensionsManagerReviewRequired,
    ExtensionsManagerTrustToken,
    ExtensionsManagerActionUnavailable,
    ExtensionsManagerFilter,
    ExtensionsManagerFilterAll,
    ExtensionsManagerFilterActive,
    ExtensionsManagerFilterNeedsReview,
    ExtensionsManagerFilterDisabled,
    ExtensionsManagerFilterError,
    ExtensionsManagerValidate,
    ExtensionsManagerInstall,
    ExtensionsManagerInstallPrompt,
    ExtensionsManagerInstallSourceRequired,
    ExtensionsManagerStateActive,
    ExtensionsManagerStateDisabled,
    ExtensionsManagerStateEnabledUntrusted,
    ExtensionsManagerStateUnstaged,
    ExtensionsManagerStateInapplicable,
    ExtensionsManagerStateUnsupported,
    ExtensionsManagerStateInactive,
    ExtensionsManagerTrustTrusted,
    ExtensionsManagerTrustNeverReviewed,
    ExtensionsManagerTrustContentChanged,
    ExtensionsManagerTrustCapabilitiesChanged,
    ExtensionsManagerScopeBuiltin,
    ExtensionsManagerScopeUser,
    ExtensionsManagerScopeWorkspace,
    ExtensionsManagerOriginBuiltin,
    ExtensionsManagerOriginHome,
    ExtensionsManagerOriginWorkspace,
    ExtensionsManagerNone,
    ExtensionsManagerWarning,
    ExtensionsManagerError,
    ExtensionsManagerYes,
    ExtensionsManagerNo,
    ExtensionsManagerPermissionsSummary,
    ExtensionsManagerMcpStdio,
    ExtensionsManagerMcpRemote,
    ExtensionsManagerMcpInvalid,
    ExtensionsManagerUnsupportedCommands,
    ExtensionsManagerUnsupportedAgents,
    ExtensionsManagerUnsupportedHooks,
    ExtensionsManagerUnsupportedLsp,
    ExtensionsManagerUnsupportedNative,
    ExtensionsManagerUnsupportedFilesystemRoots,
    ExtensionsManagerUnsupportedLifecycleMutation,
    ExtensionsManagerInventorySummary,
    ExtensionsManagerLegacyTools,
    ExtensionsManagerLegacyToolKind,
    ExtensionsManagerLegacyToolApproval,
    ExtensionsManagerLegacyToolApprovalAuto,
    ExtensionsManagerLegacyToolApprovalSuggest,
    ExtensionsManagerLegacyToolApprovalRequired,
    ExtensionsManagerLegacyToolRunHint,
    ExtensionsManagerConfirmInstall,
    ExtensionsManagerEnterDetails,
    CmdPluginNoneFound,
    CmdPluginNotFound,
    CmdPluginListHeader,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::PluginReceiptInstalled,
    MessageId::PluginReceiptInstalledDetailed,
    MessageId::PluginReceiptUpdated,
    MessageId::PluginReceiptUpdatedDetailed,
    MessageId::PluginReceiptAlreadyUpToDate,
    MessageId::PluginReceiptUninstalled,
    MessageId::PluginReceiptNeedsNetworkApproval,
    MessageId::PluginReceiptNetworkDenied,
    MessageId::PluginReceiptTrusted,
    MessageId::PluginReceiptEnabled,
    MessageId::PluginReceiptDisabled,
    MessageId::PluginReceiptTrustRevoked,
    MessageId::PluginReceiptValidation,
    MessageId::PluginReceiptValidationAll,
    MessageId::PluginReceiptValidationValid,
    MessageId::PluginReceiptValidationInvalid,
    MessageId::PluginReceiptReloaded,
    MessageId::PluginReceiptReviewRequired,
    MessageId::PluginReceiptWorkspaceReloaded,
    MessageId::ExtensionsManagerTitle,
    MessageId::ExtensionsManagerTabs,
    MessageId::ExtensionsManagerInstalled,
    MessageId::ExtensionsManagerMarketplace,
    MessageId::ExtensionsManagerMarketplaceUnavailable,
    MessageId::ExtensionsManagerMarketplaceBody,
    MessageId::ExtensionsManagerDetails,
    MessageId::ExtensionsManagerNoPlugins,
    MessageId::ExtensionsManagerNoPluginsBody,
    MessageId::ExtensionsManagerNoSelection,
    MessageId::ExtensionsManagerNoSelectionBody,
    MessageId::ExtensionsManagerVersion,
    MessageId::ExtensionsManagerSource,
    MessageId::ExtensionsManagerScope,
    MessageId::ExtensionsManagerState,
    MessageId::ExtensionsManagerTrustStatus,
    MessageId::ExtensionsManagerComponents,
    MessageId::ExtensionsManagerPermissions,
    MessageId::ExtensionsManagerMcpServers,
    MessageId::ExtensionsManagerInactiveCapabilities,
    MessageId::ExtensionsManagerReviewToken,
    MessageId::ExtensionsManagerDescription,
    MessageId::ExtensionsManagerDiagnostics,
    MessageId::ExtensionsManagerSearch,
    MessageId::ExtensionsManagerSearchIdle,
    MessageId::ExtensionsManagerMove,
    MessageId::ExtensionsManagerToggle,
    MessageId::ExtensionsManagerTrust,
    MessageId::ExtensionsManagerReload,
    MessageId::ExtensionsManagerTab,
    MessageId::ExtensionsManagerClose,
    MessageId::ExtensionsManagerConfirm,
    MessageId::ExtensionsManagerCancel,
    MessageId::ExtensionsManagerCancelled,
    MessageId::ExtensionsManagerConfirmDisable,
    MessageId::ExtensionsManagerConfirmRevoke,
    MessageId::ExtensionsManagerConfirmUpdate,
    MessageId::ExtensionsManagerConfirmUninstall,
    MessageId::ExtensionsManagerReviewRequired,
    MessageId::ExtensionsManagerTrustToken,
    MessageId::ExtensionsManagerActionUnavailable,
    MessageId::ExtensionsManagerFilter,
    MessageId::ExtensionsManagerFilterAll,
    MessageId::ExtensionsManagerFilterActive,
    MessageId::ExtensionsManagerFilterNeedsReview,
    MessageId::ExtensionsManagerFilterDisabled,
    MessageId::ExtensionsManagerFilterError,
    MessageId::ExtensionsManagerValidate,
    MessageId::ExtensionsManagerInstall,
    MessageId::ExtensionsManagerInstallPrompt,
    MessageId::ExtensionsManagerInstallSourceRequired,
    MessageId::ExtensionsManagerStateActive,
    MessageId::ExtensionsManagerStateDisabled,
    MessageId::ExtensionsManagerStateEnabledUntrusted,
    MessageId::ExtensionsManagerStateUnstaged,
    MessageId::ExtensionsManagerStateInapplicable,
    MessageId::ExtensionsManagerStateUnsupported,
    MessageId::ExtensionsManagerStateInactive,
    MessageId::ExtensionsManagerTrustTrusted,
    MessageId::ExtensionsManagerTrustNeverReviewed,
    MessageId::ExtensionsManagerTrustContentChanged,
    MessageId::ExtensionsManagerTrustCapabilitiesChanged,
    MessageId::ExtensionsManagerScopeBuiltin,
    MessageId::ExtensionsManagerScopeUser,
    MessageId::ExtensionsManagerScopeWorkspace,
    MessageId::ExtensionsManagerOriginBuiltin,
    MessageId::ExtensionsManagerOriginHome,
    MessageId::ExtensionsManagerOriginWorkspace,
    MessageId::ExtensionsManagerNone,
    MessageId::ExtensionsManagerWarning,
    MessageId::ExtensionsManagerError,
    MessageId::ExtensionsManagerYes,
    MessageId::ExtensionsManagerNo,
    MessageId::ExtensionsManagerPermissionsSummary,
    MessageId::ExtensionsManagerMcpStdio,
    MessageId::ExtensionsManagerMcpRemote,
    MessageId::ExtensionsManagerMcpInvalid,
    MessageId::ExtensionsManagerUnsupportedCommands,
    MessageId::ExtensionsManagerUnsupportedAgents,
    MessageId::ExtensionsManagerUnsupportedHooks,
    MessageId::ExtensionsManagerUnsupportedLsp,
    MessageId::ExtensionsManagerUnsupportedNative,
    MessageId::ExtensionsManagerUnsupportedFilesystemRoots,
    MessageId::ExtensionsManagerUnsupportedLifecycleMutation,
    MessageId::ExtensionsManagerInventorySummary,
    MessageId::ExtensionsManagerLegacyTools,
    MessageId::ExtensionsManagerLegacyToolKind,
    MessageId::ExtensionsManagerLegacyToolApproval,
    MessageId::ExtensionsManagerLegacyToolApprovalAuto,
    MessageId::ExtensionsManagerLegacyToolApprovalSuggest,
    MessageId::ExtensionsManagerLegacyToolApprovalRequired,
    MessageId::ExtensionsManagerLegacyToolRunHint,
    MessageId::ExtensionsManagerConfirmInstall,
    MessageId::ExtensionsManagerEnterDetails,
...
mod tests {
    ...
    #[test]
    fn plugin_lifecycle_receipts_are_explicitly_localized() {
        for locale in Locale::shipped_complete()
            .iter()
            .filter(|locale| **locale != Locale::En)
        {
            for id in [
                ...
                assert_ne!(
                    tr(*locale, id),
                    tr(Locale::En, id),
                    "{} still ships the English lifecycle receipt for {id:?}",
                    locale.tag()
                );
            }
        }
