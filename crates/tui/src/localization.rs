...
pub enum MessageId {
    ...
    SetupCardHotbarLabel,
    SetupCardHotbarBindingsLabel,
    SetupHotbarLaunchHint,
    SetupHotbarReturnHint,
    SetupHotbarOffHint,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::SetupCardHotbarLabel,
    MessageId::SetupCardHotbarBindingsLabel,
    MessageId::SetupHotbarLaunchHint,
    MessageId::SetupHotbarReturnHint,
    MessageId::SetupHotbarOffHint,
