...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::CtxInspectorModel => "Model: {}",
        MessageId::CtxInspectorSession => "Session: {}",
        MessageId::CtxInspectorTranscript => "Transcript: {} cells, {} API messages",
        MessageId::CtxInspectorWorkspaceStatus => "Workspace status: {}",
