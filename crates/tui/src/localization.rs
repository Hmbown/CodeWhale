...
pub enum MessageId {
    ...
    ContextWindowCurrent,
    ContextWindowSaved,
    ContextWindowCleared,
    ContextWindowInvalid,
    ContextWindowNeedsConcreteModel,
    CatalogStale,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::CmdContextWindowDescription,
    ...
    MessageId::PickerSearchLabel,
    MessageId::ProviderStatusLive,
    MessageId::ProviderStatusConfigured,
    MessageId::ProviderStatusUnconfigured,
    MessageId::ProviderStatusFailed,
    ...
    MessageId::ContextWindowCurrent,
    MessageId::ContextWindowSaved,
    MessageId::ContextWindowCleared,
    MessageId::ContextWindowInvalid,
    MessageId::ContextWindowNeedsConcreteModel,
    MessageId::CatalogStale,
    MessageId::CatalogRefreshFailed,
