...
pub enum MessageId {
    ...
    AutoReviewApprovalQueued,
    AutoReviewQuestionQueued,
    ApprovalChooseHint,
    ...
    WorkSurfaceNeedsInputCount,
    WorkSurfaceNeedsInputDetail,
    WorkSurfaceReviewTool,
    WorkSurfaceQuestionFallback,
    WorkSurfaceDecisionWaiting,
    WorkSurfaceDecisionNoLongerWaiting,
    // Composer slash menu.
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::AutoReviewApprovalQueued,
    MessageId::AutoReviewQuestionQueued,
    ...
    MessageId::WorkSurfaceNeedsInputCount,
    MessageId::WorkSurfaceNeedsInputDetail,
    MessageId::WorkSurfaceReviewTool,
    MessageId::WorkSurfaceQuestionFallback,
    MessageId::WorkSurfaceDecisionWaiting,
    MessageId::WorkSurfaceDecisionNoLongerWaiting,
