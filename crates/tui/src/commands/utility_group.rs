...
impl Command for Queue {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::queue::queue(app, args) }
}
...
impl Command for Stash {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::stash::stash(app, args) }
}
...
impl Command for Hooks {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::hooks::hooks(app, args) }
}
...
impl Command for Anchor {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::anchor::anchor(app, args) }
}
...
impl Command for Network {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::network::network(app, args) }
}
...
impl Command for Mcp {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::mcp::mcp(app, args) }
}
...
impl Command for Task {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::task::task(app, args) }
}
...
impl Command for Jobs {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::jobs::jobs(app, args) }
}
...
impl Command for Slop {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::config::slop(app, args) }
}
