...
impl Command for Config {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::config::config_command(app, args) }
}
...
impl Command for Settings {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { super::config::show_settings(app) }
}
...
impl Command for Status {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { super::status::status(app) }
}
...
impl Command for Statusline {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { super::config::status_line(app) }
}
...
impl Command for Theme {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::config::theme(app, args) }
}
...
impl Command for Verbose {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::config::verbose(app, args) }
}
...
impl Command for Trust {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { super::config::trust(app, args) }
}
...
impl Command for Logout {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { super::config::logout(app) }
}
