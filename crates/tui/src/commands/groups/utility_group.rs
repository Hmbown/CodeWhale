...
impl Command for Queue {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::queue::queue(app, args) }
}
...
impl Command for Stash {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::stash::stash(app, args) }
}
...
impl Command for Hooks {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::hooks::hooks(app, args) }
}
...
impl Command for Anchor {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::anchor::anchor(app, args) }
}
...
impl Command for Network {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::network::network(app, args) }
}
...
impl Command for Mcp {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::mcp::mcp(app, args) }
}
...
impl Command for Task {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::task::task(app, args) }
}
...
impl Command for Jobs {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::jobs::jobs(app, args) }
}
...
impl Command for Slop {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::config::slop(app, args) }
}
