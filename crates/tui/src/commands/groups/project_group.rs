...
impl Command for Change {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::change::change(app, args) }
}
...
impl Command for Init {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::init::init(app) }
}
...
impl Command for Lsp {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::config::lsp_command(app, args) }
}
...
impl Command for Share {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::share::share(app, args) }
}
...
impl Command for Goal {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::goal::hunt(app, args) }
}
