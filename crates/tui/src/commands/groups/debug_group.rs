...
impl Command for Translate {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::core::translate(app) }
}
...
impl Command for Tokens {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::tokens(app) }
}
...
impl Command for Cost {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::cost(app) }
}
...
impl Command for Balance {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::balance::balance(app) }
}
...
impl Command for Cache {
    ...
    fn execute(&self, app: &mut App, args: Option<&str>) -> CommandResult { crate::commands::back::debug::cache(app, args) }
}
...
impl Command for System {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::system_prompt(app) }
}
...
impl Command for Context {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::context(app) }
}
...
impl Command for Edit {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::edit(app) }
}
...
impl Command for Diff {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::diff(app) }
}
...
impl Command for Retry {
    ...
    fn execute(&self, app: &mut App, _args: Option<&str>) -> CommandResult { crate::commands::back::debug::retry(app) }
}
