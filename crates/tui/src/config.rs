...
impl Config {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        {
            anyhow::bail!(
                "Invalid provider '{provider}': expected deepseek, deepseek-cn, nvidia-nim, openai, atlascloud, wanjie-ark, openrouter, novita, fireworks, siliconflow, moonshot, sglang, vllm, or ollama."
            );
        }
