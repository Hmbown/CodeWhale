...
export const home: HomeDict = {
  ...
  startLede:
    "Installare → prima sessione senza chiavi → collegare un provider → configurare la tua Pod. I termini sono definiti nella pagina del vocabolario.",
  ...
  surfaces: [
    ...
    ["Pod", "Lavoro multi-agente durevole"],
  ],
