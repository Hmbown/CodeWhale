...
export const home: HomeDict = {
  ...
  currentSource: "Font actual",
  sourceCandidate: "Font candidata",
  providerRoutes: "{count} rutes de proveïdors",
  publishedRelease: "versió publicada",
  figcaptionSourceCandidate: "font candidata",
