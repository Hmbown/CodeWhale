...
export const home: HomeDict = {
  ...
  startLede:
    "Встановлення → перший сеанс без ключів → підключення провайдера → перший робочий процес у Pod. Терміни пояснено на сторінці словника.",
  ...
  surfaces: [
    ...
    ["Pod", "Стійка багатоагентна робота"],
  ],
