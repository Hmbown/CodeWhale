        ...
        <div className="col-span-2 md:col-span-2 space-y-4">
          ...
          <div className="pt-2 border-t border-paper-line/20">
            ...
            <div className="flex flex-wrap gap-3 text-xs">
              ...
              {GITEE_ENABLED && <a href="https://gitee.com/Hmbown/deepseek-tui" className="text-ink-soft hover:underline" target="_blank" rel="noopener">Gitee 镜像</a>}
              <a href="https://cnb.cool/codewhale.net/codewhale" className="text-ink-soft hover:underline" target="_blank" rel="noopener">CNB 镜像</a>
