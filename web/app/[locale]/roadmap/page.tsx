...
const tracksEn = [
  {
    ...
    items: [
      ...
      { title: "Three operating modes", note: "Plan (read-only authority), Work (execution), and Operate (Pod/Workflow orchestration) keep one primitive vocabulary; Ask / Auto-Review / Full Access remains an orthogonal approval posture." },
...
const tracksZh = [
  {
    ...
    items: [
      ...
      { title: "三种运行模式", note: "Plan（只读权限）、Work（执行）与 Operate（Pod / Workflow 编排）使用同一套基础工具名称；Ask、Auto-Review 与 Full Access 审批姿态独立设置。" },
