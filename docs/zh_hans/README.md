...
2. [ENTERPRISE.md](ENTERPRISE.md) —— 企业审阅：本地运行时、自带密钥、第一方遥测与崩溃转储
3. [FLEET.md](../FLEET.md) —— Fleet 角色与多模型编排
4. [MCP.md](../MCP.md) —— MCP 模型上下文协议接入
5. [SKILLS.md](../SKILLS.md) —— 技能（skill）的安装、管理与使用
6. [SUBAGENTS.md](../SUBAGENTS.md) —— 子智能体（Fleet）机制
7. [HOOKS.md](../HOOKS.md) —— 钩子机制与自动化
8. [TOOL_SURFACE.md](../TOOL_SURFACE.md) —— 工具面：AI 当前可用的工具契约
9. [AGENT_RUNTIME.md](../AGENT_RUNTIME.md) —— Agent 运行时：子智能体、exec 与 Fleet 的关系
