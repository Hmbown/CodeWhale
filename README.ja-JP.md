...
> [!Note]
> DeepSeek-V4-Pro の 75% 割引は、当初 2026 年 5 月 31 日 23:59（北京時間）に終了する予定でしたが、現在は恒久的な割引となりました。最新の価格情報については、公式の [DeepSeek 価格ページ](https://api-docs.deepseek.com/quick_start/pricing) をご確認ください。README に記載されているすべての料金は、公式に公開されている数値と一致しています。
